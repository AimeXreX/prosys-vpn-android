...
object AppConfig {
    ...
    const val PRO_SYS_API_BASE_URL = "https://vpn.prosysvpn.top"
    const val PRO_SYS_SITE_URL = "https://vpn.prosysvpn.top/"
    const val PRO_SYS_BOT_URL = "https://t.me/ProSySsellbot"
    const val PRO_SYS_CHANNEL_URL = "https://t.me/Prosys_VPN"
    const val APP_URL = PRO_SYS_SITE_URL
    const val APP_API_URL = "https://api.github.com/repos/2dust/v2rayNG/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "${PRO_SYS_API_BASE_URL}/privacy"
    const val APP_PROMOTION_URL = "aHR0cHM6Ly92cG4ucHJvc3lzdnBuLnRvcC8="
    const val TG_CHANNEL_URL = PRO_SYS_CHANNEL_URL
    ...
    const val RAY_NG_CHANNEL_NAME = "ProSyS VPN Background Service"
