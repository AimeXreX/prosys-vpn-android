...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            PreferenceGroupHeader(title = stringResource(R.string.prosys_reset_settings))
            SettingsMenuItem(
                title = stringResource(R.string.prosys_reset_settings),
                subtitle = stringResource(R.string.prosys_reset_settings_summary),
    ...
    if (showResetConfirm) {
        ConfirmDialog(
            title = stringResource(R.string.prosys_reset_settings),
            message = stringResource(R.string.prosys_reset_settings_confirm),
            confirmText = stringResource(R.string.prosys_confirm),
            dismissText = stringResource(R.string.prosys_cancel),
            onConfirm = {
                MmkvManager.resetSettingsToDefaults()
                context.toastSuccess(R.string.prosys_reset_settings_done)
